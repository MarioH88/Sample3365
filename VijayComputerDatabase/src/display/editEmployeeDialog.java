...
public class editEmployeeDialog {
	...
	public static void newWindow() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					editEmployeeDialog window = new editEmployeeDialog();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Please enter the \"Employee ID #\" to select the student you would like to edit");
